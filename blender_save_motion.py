...
def extract_keypoint_poses_for_frame(frame_number):
    ...
    if not armature_objects:
        print(
            "No armature found in the scene. Ensure the FBX contains an armature object."
        )
        return joint_poses
...
fbx_file_path = (
    "/home/jianrenw/Downloads/Actorcore-Maya-1022-573782/Motion/male-idle_279398.fbx"
)
clear_scene()
...
if last_keyframe is not None and last_keyframe > 0:
    ...
    # Specify the output JSON file path
    output_file_path = "/home/jianrenw/mocap/data/actioncore/raw/{}.json".format(
        fbx_file_path.split("/")[-1].split(".")[0]
    )
