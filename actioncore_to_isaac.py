...
useful_body_indices = [i for i, name in enumerate(rigid_body_names) if 'leftFoot' not in name and 'rightFoot' not in name]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_path", type=str, help="dataset directory", default="/home/jianrenw/mocap/data/actioncore/joints"
    )
    parser.add_argument(
        "--out_dir", type=str, help="output directory", default="/home/jianrenw/mocap/data/actioncore"
    )
