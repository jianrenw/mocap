...
def conver_video_to_adam(output_pth):
    ...
    physicsClient, humanoid = setup_pybullet('/home/jianrenw/mocap/robots/adam_standard/urdf/adam_standard_low.urdf', gui=False)
    ...
    skeleton = np.concatenate((skeleton[:, :, 0:1], -skeleton[:, :, 2:3], skeleton[:, :, 1:2]), axis=2)
...
if __name__=='__main__':
    ...
    parser.add_argument(
        "--motion_file", type=str, help="dataset directory", default="/home/jianrenw/mocap/data/videos/raw"
    )
    parser.add_argument('--output_pth', type=str, default='/home/jianrenw/mocap/data/videos/processed', 
